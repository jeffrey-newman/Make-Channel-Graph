...
struct ChannelNode
{
    ...
    ChannelNode
    (): node_id(-1), cntrl_node_id(-1), row(-1), col(-1), down_cntrl_id(-1), down_cntrl_dist(-1), up_cntrl_id(-1), up_cntrl_dist(-1), type(NOT_CNTRL), terminal_type(NOT_TERMINAL), level(-999), elevation(-999)
    {
